...
export default function HomePage() {
  ...
  return (
    <ClinicianLayout
      title={`Welcome Back, Dr. ${doctor?.full_name?.split(" ").pop() || "Doctor"}`}
    ...
    >
      <div className="home-top-bar">
        <div>
          ...
          <p className="home-welcome-sub">Review previous predictions and reopen saved reports.</p>
        </div>
      </div>
      ...
      {!loading && !error && filtered.length === 0 && (
        <div className="panel" style={{ padding: 60, textAlign: "center" }}>
          ...
          <p className="empty-hint">Click &quot;New Patient&quot; to add your first patient and run a prediction.</p>
        </div>
      )}
